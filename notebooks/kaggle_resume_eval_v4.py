"""
Medical VQA - Resume Evaluation V4 from WandB on Kaggle (T4 x2)
...
runs = api.runs("dvydinh/medicalVQA", filters={"display_name": "qlora-llava-vqa-rad-v4"})
run = runs[0]
...
COMMIT_DATE = "2026-05-17T10:00:00+07:00"
commit_cmd = (
...
print("results pushed to github results_v4 folder")

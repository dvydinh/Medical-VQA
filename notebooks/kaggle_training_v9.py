"""
Medical VQA - Training V9 (Mixed Dataset: VQA-RAD + SLAKE) on Kaggle (T4 x2)
...
# DATA IS NOW PROVIDED VIA KAGGLE INPUT FOLDER (Output of kaggle_prepare_data.ipynb)
# Make sure to add the dataset and rename its directory to 'medvqa-mixed-data'


# ==== CELL 4: validate dataset ====

# We skip validate_data.py because the data is already validated during prep.
...
MIXED_DATA_DIR = "/kaggle/input/medvqa-mixed-data/data/raw"
data_path = os.path.join(MIXED_DATA_DIR, "MedVQA_Mixed_Dataset.json")
image_dir = os.path.join(MIXED_DATA_DIR, "images_mixed")
...
results_dir = Path(WORK_DIR) / "results_v9"
...
print("check: https://github.com/dvydinh/Medical-VQA/tree/main/results_v9")
